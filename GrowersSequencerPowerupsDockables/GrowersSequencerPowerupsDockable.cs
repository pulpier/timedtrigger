...
namespace GrowersAstro.NINA.GrowersSequencerPowerups.GrowersSequencerPowerupsDockables {
    ...
    public class GrowersSequencerPowerupsDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public GrowersSequencerPowerupsDockable(
            ...
            dict.Source = new Uri("GrowersAstro.NINA.GrowersSequencerPowerups;component/GrowersSequencerPowerupsDockables/GrowersSequencerPowerupsDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["GrowersAstro.NINA.GrowersSequencerPowerups_AltitudeSVG"];
