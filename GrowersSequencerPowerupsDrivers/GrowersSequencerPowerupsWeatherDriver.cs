...
namespace GrowersAstro.NINA.GrowersSequencerPowerups.GrowersSequencerPowerupsDrivers {
    ...
    /// </summary>
    public class GrowersSequencerPowerupsWeatherDriver : BaseINPC, IWeatherData {
         public GrowersSequencerPowerupsWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"GrowersSequencerPowerups Weather Data ({deviceId})";
    ...
    public string Category => "GrowersSequencerPowerups Weather Driver";
