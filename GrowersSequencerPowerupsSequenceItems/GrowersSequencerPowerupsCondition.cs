...
namespace GrowersAstro.NINA.GrowersSequencerPowerups.GrowersSequencerPowerupsTestCategory {
    ...
    public class GrowersSequencerPowerupsCondition : SequenceCondition {
        /// <summary>
        ...
        public GrowersSequencerPowerupsCondition() {
            IsTruthy = true;
        }
        ...
        public override object Clone() {
            return new GrowersSequencerPowerupsCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(GrowersSequencerPowerupsCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}