...
namespace GrowersAstro.NINA.GrowersSequencerPowerups.GrowersSequencerPowerupsTestCategory {
    /// <summary>
    ...
    public class GrowersSequencerPowerupsInstruction : SequenceItem {
        /// <summary>
        ...
        public GrowersSequencerPowerupsInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public GrowersSequencerPowerupsInstruction(GrowersSequencerPowerupsInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new GrowersSequencerPowerupsInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(GrowersSequencerPowerupsInstruction)}, Text: {Text}";
        }
    }
}